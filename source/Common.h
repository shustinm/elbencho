...
#define PHASENAME_GETOBJRETENTION       "GETOBJRETENT"
#define PHASENAME_GETOBJLEGALHOLD       "GETOBJLGHOLD"
#define PHASENAME_PUTOBJECTMETADATA     "PUTOBJMD"
#define PHASENAME_PUTOBJRETENTION       "PUTOBJRETENT"
#define PHASENAME_PUTOBJLEGALHOLD       "PUTOBJLGHOLD"
...
enum BenchPhase
{
    ...
    BenchPhase_GET_OBJECT_RETENTION,
    BenchPhase_GET_OBJECT_LEGAL_HOLD,
    BenchPhase_GET_S3_OBJECT_MD,
    BenchPhase_PUT_OBJECT_RETENTION,
    BenchPhase_PUT_OBJECT_LEGAL_HOLD,
