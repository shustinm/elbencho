...
void Coordinator::runBenchmarks()
{
	...
	std::array allBenchPhasesArray
	{
        ...
        BenchPhaseConfig { BenchPhase_PUT_OBJECT_RETENTION, progArgs.getRunS3PutObjectRetention() },
        BenchPhaseConfig { BenchPhase_PUT_OBJECT_LEGAL_HOLD, progArgs.getRunS3PutObjectLegalHold() },
        ...
        BenchPhaseConfig { BenchPhase_GET_OBJECT_RETENTION, progArgs.getRunS3GetObjectRetention() },
        BenchPhaseConfig { BenchPhase_GET_OBJECT_LEGAL_HOLD, progArgs.getRunS3GetObjectLegalHold() },
