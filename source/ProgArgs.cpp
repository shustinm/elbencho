...
/*s3c*/	(ARG_S3CORSORIGIN_LONG, bpo::value(&this->s3CorsOrigin),
            "S3 CORS origin header value. When provided, elbencho will add the Origin "
            "header to S3 requests and validate the Access-Control-Allow-Origin response header.")
